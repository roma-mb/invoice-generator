    ...
    <div v-if="isOpen" class="fixed z-10 inset-0 overflow-y-auto" id="modal">
        ...
        >
            ...
            >
                ...
                <div class="sm:mt-3 lg:mt-5">
                    <button
                        class="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo text-base font-medium text-white hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-xl"
